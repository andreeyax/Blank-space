...
class PredlaganjeIzvodjacaViewTests(TestCase):
    ...
    def test_pregled_pravila_igre(self):
        ...
        client = Client()
        response = client.get(reverse('predlaganje_pesama'))

        # provera statusa i template-a
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, './predlaganje/predlaganje_pesama.html')
        ...
        self.assertContains(response, 'Naziv pesme')
