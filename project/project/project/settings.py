...
SECRET_KEY = 'django-insecure-6sqtgpw13uxj&$ivy3o@ip!$kk6(i524z$f=_5o9)hw2md01+_'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'appblankspace', 'static'),
]

SONG_UPLOAD_DIR = os.path.join(BASE_DIR, 'appblankspace', 'static')
